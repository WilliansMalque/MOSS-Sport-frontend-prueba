...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Imprime las respuestas en la consola para comprobar la estructura de los datos
    console.log('Torneos:', torneosResponse.data); // Aquí puedes ver la estructura de los torneos
    console.log('Partidos:', partidosResponse.data); // Lo mismo para los partidos
    console.log('Equipos:', equipoDetResponse.data); // Y los equipos
  ...
  // Función para obtener el nombre del equipo por su id
  const getNombreEquipo = (id) => {
    const equipo = equipos.find((equipo) => equipo.equipo_id === id);
    return equipo ? equipo.nombre_equipo : 'Equipo no encontrado';
  };

  // Función para obtener el nombre del torneo por su id
